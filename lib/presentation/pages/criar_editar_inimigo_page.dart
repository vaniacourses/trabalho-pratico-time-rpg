  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      final params = InimigoParams(
        ...
        // Armas e habilidades podem ser adicionadas aqui no futuro
      );
        ...
        child: ListView(
          ...
          children: [
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Nome do Inimigo'),
              validator: (v) => v!.isEmpty ? 'Campo obrigatório' : null,
            ),
            TextFormField(
              controller: _tipoController,
              decoration: const InputDecoration(labelText: 'Tipo (ex: Besta, Humanoide)'),
              validator: (v) => v!.isEmpty ? 'Campo obrigatório' : null,
            ),
            TextFormField(
            ...
            GridView.count(
              ...
              children: [
                 Padding(
                  ...
                  child: TextFormField(controller: _forController, decoration: const InputDecoration(labelText: 'FOR', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: TextFormField(controller: _desController, decoration: const InputDecoration(labelText: 'DES', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: TextFormField(controller: _conController, decoration: const InputDecoration(labelText: 'CON', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: TextFormField(controller: _intController, decoration: const InputDecoration(labelText: 'INT', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: TextFormField(controller: _sabController, decoration: const InputDecoration(labelText: 'SAB', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: TextFormField(controller: _carController, decoration: const InputDecoration(labelText: 'CAR', border: OutlineInputBorder()), keyboardType: TextInputType.number, textAlign: TextAlign.center),
                ),
              ],
            ),
            const SizedBox(height: 24),
            ElevatedButton(
              ...
              child: Text(isEditing ? 'Salvar Alterações' : 'Criar Inimigo'),
            ),
          ],
        ),
      ),
